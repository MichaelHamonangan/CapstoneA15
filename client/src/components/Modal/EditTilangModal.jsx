...
const EditTilangModal = (props) => {
  ...
  const [inputs, setInputs] = useState({
    nomorKendaraan: props.data.nomorKendaraan,
    tanggal: props.data.tanggal,
    lokasi: props.data.lokasi,
  ...
  const handleSubmit = (event) => {
    ...
    axios
    .put("http://localhost:5000/api/tilang/" + props.data._id, inputs, {
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-[#FAFAFA] outline-none focus:outline-none">
                ...
                <div className="w-[400px] flex">
                  <div className="mt-4 mb-6 align-center mx-auto">
                    <h1 className="text-center font-bold text-xl">EDIT TILANG</h1>
...
export default EditTilangModal;
